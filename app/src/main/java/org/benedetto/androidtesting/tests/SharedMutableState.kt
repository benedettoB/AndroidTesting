...
object SharedMutableState {
    ...
    suspend fun massiveRun(action: suspend () -> Unit) {
        ...
        log(TAG,"Completed ${n * k} actions in $time ms")
    }
    ...
    fun beginCoarseGrainControl() = runBlocking {
        ...
        log(TAG,"Coarse: Counter = $counter")
        log(TAG,"volatileCounter = $volatileCounter")
        log(TAG,"atomicCounter = $atomicCounter")
        log(TAG,"mutexCounter = $mutexCounter")
        log(TAG,"synchronizedCounter = $synchronizedCounter")
        log(TAG,"synchronizedCounterTwo = $synchronizedCounterTwo")
    }
